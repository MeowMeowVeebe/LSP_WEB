...
<link rel="stylesheet" href="<?php echo ASSET_URL; ?>dist/css/output.css">
...
<main class="grid min-h-full place-items-center bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
  <div class="text-center">
    ...
    <div class="mt-10 flex items-center justify-center gap-x-6">
      <a href="<?=BASE_URL?>home" class="rounded-md bg-red-700 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-red-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Go back home</a>
